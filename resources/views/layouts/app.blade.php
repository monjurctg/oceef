...
<body class="bg-gray-50 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
            ...
            <div class="p-4 border-t border-primary-700">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="text-xs text-primary-200">{{ ucfirst($user['type']) }}</div>
                    </div>
                </div>
                
                <a href="{{ route('logout') }}" class="flex items-center p-3 rounded-lg hover:bg-primary-700 transition-colors">
        ...
        <!-- Main Content -->
        <div id="main-content" class="flex-1 flex flex-col overflow-hidden transition-all duration-300 ml-0 lg:ml-64">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center">
                                <span class="text-xs font-bold text-primary-800">{{ strtoupper(substr($user['name'], 0, 2)) }}</span>
                            </div>
