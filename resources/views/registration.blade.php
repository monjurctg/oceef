...
<head>
    ...
    <title>Omargoni MES College Ex-Cadet Registration</title>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-md rounded-lg">
            <div class="bg-blue-800 text-white py-4 px-6">
                <h1 class="text-2xl font-bold text-center">Omargoni MES College Ex-Cadet Data Bank</h1>
            ...
            <form id="registrationForm" method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data">
                ...
                <div class="form-section">
                        ...
                        <div>
                            ...
                            <div class="year-range-container">
                                <div class="year-range-inputs">
                                    <input required type="number" name="cadetship_start" id="cadetship_start" class="form-input w-full" />
                                    <span class="self-center text-gray-500">to</span>
                                    <input required type="number" name="cadetship_end" id="cadetship_end" class="form-input w-full" />
                                </div>
                            </div>
                            <input type="hidden" name="cadetship_year" id="cadetship_year" />
                        </div>
                        <div>
                            <label class="form-label">A02. Cadet No<br><span class="text-sm text-gray-600 font-normal">এ০২. ক্যাডেট নম্বর</span></label>
                            <input type="text" name="cadetship_no" class="form-input w-full" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="last_appointment" class="form-input" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="radio-group">
                                <div class="flex space-x-4">
                                    <label class="radio-label"><input type="radio" name="platoon_leader" value="YES" class="radio-input"> YES</label>
                                    <label class="radio-label"><input type="radio" name="platoon_leader" value="NO" class="radio-input"> NO</label>
                                </div>
                            </div>
                        </div>
                        <div id="platoonYearContainer" class="hidden">
                            ...
                            <div class="year-range-container">
                                <div class="year-range-inputs">
                                    <input type="number" name="platoon_start" id="platoon_start" class="form-input w-full" />
                                    <span class="self-center text-gray-500">to</span>
                                    <input type="number" name="platoon_end" id="platoon_end" class="form-input w-full" />
                                </div>
                            </div>
                            <input type="hidden" name="platoon_year" id="platoon_year" />
                        </div>
                    </div>
                     <div class="mb-4">
              ...
              <tr>
                ...
                <td class="p-2 border-b"><input type="text" name="training_camp_name[]" class="form-input border-none bg-transparent w-full min-w-40" /></td>
                <td class="p-2 border-b"><input type="text" name="training_camp_appointment[]" class="form-input border-none bg-transparent w-full" /></td>
                ...
                <td class="p-2 border-b"><input type="text" name="training_camp_year[]" class="form-input border-none bg-transparent w-full" /></td>
                <td class="p-2 border-b"><button type="button" onclick="removeRow(this)" class="text-red-500">−</button></td>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="form-label">A08. Name of your Cadet in-charge
                            <br><span class="text-sm text-gray-600 font-normal">   এ০৮. আপনার ক্যাডেট ইনচার্জের নাম লিখুন</span>
                         
                            </label>
                            <input required type="text" name="cadet_incharge" class="form-input" />
                        </div>
                    </div>
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            @foreach ($officers as $officer)
                                <label class="flex items-center space-x-3 bg-white border rounded-lg p-3 shadow-sm hover:shadow-md transition">
                                    <input type="checkbox" name="bncc_officers_names[]" value="{{ $officer }}" class="form-checkbox text-blue-600 h-5 w-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="form-label">
                                A10. Were you previously a junior division cadet?<br>
                                <span class="text-gray-600">এ১০. আপনি কি পূর্বে জুনিয়র ডিভিশনের ক্যাডেট ছিলেন?</span>
                            </label>
                            <div class="radio-group">
                                <div class="flex space-x-4">
                                    <label class="radio-label">
                                        <input type="radio" name="isJuniorDivision" value="YES" class="radio-input" onchange="toggleJuniorFields()"> YES
                                    </label>
                                    <label class="radio-label">
                                        <input type="radio" name="isJuniorDivision" value="NO" class="radio-input" onchange="toggleJuniorFields()"> NO
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div id="juniorInstitutionContainer" class="hidden">
                            <label class="form-label">
                                A11. If yes, name of your institution<br>
                                <span class="text-gray-600">এ১১. উত্তর হ্যাঁ হলে আপনার প্রতিষ্ঠানের নাম উল্লেখ করুন</span>
                            </label>
                            <input type="text" name="junior_institution" class="form-input" />
                        </div>
                    </div>
                    <div id="juniorFields" class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 hidden">
                        <div>
                            <label class="form-label">
                                A12. Junior Division Last Rank<br>
                                <span class="text-sm text-gray-600 font-normal">এ১২. জুনিয়র ডিভিশনে আপনার সর্বশেষ পদবী কি ছিল?</span>
                            </label>
                        ...
                        <div>
                            <label class="form-label">
                                A13. Junior Division Cadetship Year<br>
                                <span class="text-sm text-gray-600 font-normal">এ১৩. কত সাল থেকে কত সাল আপনি জুনিয়র ডিভিশনের ক্যাডেট ছিলেন?</span>
                            </label>
                            <div class="year-range-container">
                                <div class="year-range-inputs">
                                    <input type="number" name="junior_start" id="junior_start" class="form-input w-1/3" />
                                    <span class="text-gray-600">to</span>
                                    <input type="number" name="junior_end" id="junior_end" class="form-input w-1/3" />
                                </div>
                            </div>
                            <input type="hidden" name="junior_cadetship_year" id="junior_cadetship_year" />
                        </div>
                    </div>
                </div>
                <div class="form-section">
                ...
                <div class="form-section">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <input type="url" name="social[facebook]" class="form-input w-full" placeholder="Facebook profile URL" />
                        </div>
                        <div class="flex items-center gap-4">
                            <img src="https://cdn-icons-png.flaticon.com/512/5968/5968804.png" alt="X" class="w-6 h-6" />
                            <input type="url" name="social[x]" class="form-input w-full" placeholder="X (Twitter) profile URL" />
                        </div>
                        <div class="flex items-center gap-4">
                            <img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="LinkedIn" class="w-6 h-6" />
                            <input type="url" name="social[linkedin]" class="form-input w-full" placeholder="LinkedIn profile URL" />
                        </div>
                        <div class="flex items-center gap-4">
                            <img src="https://cdn-icons-png.flaticon.com/512/1384/1384063.png" alt="Instagram" class="w-6 h-6" />
                            <input type="url" name="social[instagram]" class="form-input w-full" placeholder="Instagram profile URL" />
                        </div>
                    </div>
                </div>
                <div class="form-section">
    ...
    <table class="reference-table min-w-full border border-gray-200" id="referenceTable">
      ...
      <tbody id="referenceBody">
        <tr>
          ...
          <td class="p-2 border-b">
            <input type="text" name="reference_name[]" class="form-input border-none bg-transparent w-full" placeholder="Name" />
          </td>
          <td class="p-2 border-b">
            <input type="tel" name="reference_phone[]" class="form-input border-none bg-transparent w-full" placeholder="Phone" />
          </td>
          <td class="p-2 border-b">
  ...
  <button type="button" onclick="addRow2('referenceTable')" class="mt-2 px-4 py-1 bg-blue-500 text-white rounded">+ Add Row</button>
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="emergency_person" class="form-input text-sm" />
                        </div>
                        <div>
                            <label class="form-label">E02. Relation with the Person<br><span class="text-gray-600">ই০২. ব্যক্তির সাথে সম্পর্ক</span></label>
                            <input type="text" name="emergency_relation" class="form-input text-sm" />
                        </div>
                        <div>
                            <label class="form-label">E03. Emergency Contact Number<br><span class="text-gray-600">ই০৩. জরুরী মোবাইল নম্বর</span></label>
                            <input type="text" name="emergency_contact" class="form-input text-sm" />
                        </div>
                    </div>
                </div>
                <div class="form-section">
        <h2 class="form-title">(F) Upload Your Passport Size Photo<br>
            <span class="text-gray-600 text-base">এফ: আপনার পাসপোর্ট সাইজের ছবি আপলোড করুন</span>
        </h2>
        <input type="file" name="photo" accept="image/*" class="form-input" />
                ...
                <div class="flex flex-col md:flex-row md:space-x-4">
                    <button id="submitBtn" type="submit" class="btn-submit bg-red-500" disabled>Submit & Register for OCECF Membership</button>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('input[name="platoon_leader"]').forEach(radio => {
                radio.addEventListener('change', () => {
                    ...
                    // if (radio.value === 'YES') validateYearRange('platoon_start', 'platoon_end', 'Platoon leadership years');
                });
            });
            ...
            document.querySelectorAll('input[name="isJuniorDivision"]').forEach(radio => {
                radio.addEventListener('change', () => {
                    if (radio.value === 'YES') {
                        // validateRequired(document.querySelector('input[name="junior_institution"]'), 'Junior institution');
                        // validateRequired(document.querySelector('select[name="junior_last_rank"]'), 'Junior last rank');
                        // validateYearRange('junior_start', 'junior_end', 'Junior cadetship years');
                    }
                });
            });
            ...
            form.addEventListener('submit', (e) => {
                ...
                isValid = validateFileUpload(document.querySelector('input[name="photo"]'), 'Passport photo') && isValid;
